...
// Validate reports whether addr is a syntactically valid email address.
// This is a best-effort format check — it does not verify that the address
// exists or is reachable. The only reliable validation is a successful
// magic-link verification, which proves the email reached the user.
