...
//			RefreshAccessTokenFunc: func(ctx context.Context, rawToken string) (mdl.TokenPair, error) {
...
//			},
//			VerifyMagicLinkFunc: func(ctx context.Context, rawToken string) (mdl.TokenPair, error) {
...
func (mock *MockedAuthCore) RefreshAccessToken(ctx context.Context, rawToken string) (mdl.TokenPair, error) {
...
func (mock *MockedAuthCore) VerifyMagicLink(ctx context.Context, rawToken string) (mdl.TokenPair, error) {
