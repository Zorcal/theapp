...
const (
	ProjectService_ListProjects_FullMethodName = "/theapp.v1.ProjectService/ListProjects"
)
...
//
// ProjectService provides project discovery and management.
type ProjectServiceClient interface {
	// Lists the projects accessible to the authenticated caller.
...
var ProjectService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "theapp.v1.ProjectService",
