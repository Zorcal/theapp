...
// SystemRoleFilter specifies criteria for filtering system roles in a ListSystemRoles request.
// Reserved for future filter criteria; it has no fields yet.
...
func (x *SystemRoleFilter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SystemRoleFilter) ProtoMessage() {}

func (x *SystemRoleFilter) ProtoReflect() protoreflect.Message {
	mi := &file_system_role_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SystemRoleFilter.ProtoReflect.Descriptor instead.
func (*SystemRoleFilter) Descriptor() ([]byte, []int) {
...
type ListSystemRolesRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Filter criteria. All fields are optional; omitted fields match all system roles.
	Filter        *SystemRoleFilter `protobuf:"bytes,1,opt,name=filter,proto3" json:"filter,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListSystemRolesRequest) GetFilter() *SystemRoleFilter {
	if x != nil {
		return x.Filter
	}
	return nil
...
func (x *ListSystemRolesResponse) GetRoles() []*Role {
	if x != nil {
		return x.Roles
	}
	return nil
...
func (x *ListSystemRoleAssignmentsResponse) GetRoleNames() []string {
	if x != nil {
		return x.RoleNames
	}
	return nil
...
const file_system_role_proto_rawDesc = "" +
	"\n" +
	"\x11system_role.proto\x12\ttheapp.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/api/field_info.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\n" +
	"role.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"a\n" +
	"\x17AssignSystemRoleRequest\x12 \n" +
	"\trole_name\x18\x01 \x01(\tB\x03\xe0A\x02R\broleName\x12$\n" +
	"\auser_id\x18\x02 \x01(\tB\v\xe0A\x02\xe2\x8c\xcf\xd7\b\x02\b\x01R\x06userId\"c\n" +
	"\x19UnassignSystemRoleRequest\x12 \n" +
	"\trole_name\x18\x01 \x01(\tB\x03\xe0A\x02R\broleName\x12$\n" +
	"\auser_id\x18\x02 \x01(\tB\v\xe0A\x02\xe2\x8c\xcf\xd7\b\x02\b\x01R\x06userId\"\x12\n" +
	"\x10SystemRoleFilter\"M\n" +
	"\x16ListSystemRolesRequest\x123\n" +
	"\x06filter\x18\x01 \x01(\v2\x1b.theapp.v1.SystemRoleFilterR\x06filter\"@\n" +
	"\x17ListSystemRolesResponse\x12%\n" +
	"\x05roles\x18\x01 \x03(\v2\x0f.theapp.v1.RoleR\x05roles\"\x80\x01\n" +
	...
	"\x0fnext_page_token\x18\x03 \x01(\tR\rnextPageToken\"\x84\x01\n" +
	...
	"!ListSystemRoleAssignmentsResponse\x12\x1d\n" +
	"\n" +
	"role_names\x18\x01 \x03(\tR\troleNames\x12\x1d\n" +
	"\n" +
	"total_size\x18\x02 \x01(\x05R\ttotalSize\x12&\n" +
	"\x0fnext_page_token\x18\x03 \x01(\tR\rnextPageToken2\xc2\b\n" +
	"\x11SystemRoleService\x12\xbf\x01\n" +
	"\x10AssignSystemRole\x12\".theapp.v1.AssignSystemRoleRequest\x1a\x16.google.protobuf.Empty\"o\x92AJrH\n" +
	"F\n" +
	"\fx-project-id\x122ID of the \"theapp\" organization's control project.\x18\x03(\x01\x82\xd3\xe4\x93\x02\x1c:\x01*\"\x17/v1/system-roles:assign\x12\xc5\x01\n" +
	"\x12UnassignSystemRole\x12$.theapp.v1.UnassignSystemRoleRequest\x1a\x16.google.protobuf.Empty\"q\x92AJrH\n" +
	"F\n" +
	"\fx-project-id\x122ID of the \"theapp\" organization's control project.\x18\x03(\x01\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/v1/system-roles:unassign\x12\xbf\x01\n" +
	...
	"F\n" +
	"\fx-project-id\x122ID of the \"theapp\" organization's control project.\x18\x03(\x01\x82\xd3\xe4\x93\x02*\x12(/v1/system-roles/{role_name}:permissions\x12\xe8\x01\n" +
...
var file_system_role_proto_goTypes = []any{
	(*AssignSystemRoleRequest)(nil),           // 0: theapp.v1.AssignSystemRoleRequest
	(*UnassignSystemRoleRequest)(nil),         // 1: theapp.v1.UnassignSystemRoleRequest
	(*SystemRoleFilter)(nil),                  // 2: theapp.v1.SystemRoleFilter
	(*ListSystemRolesRequest)(nil),            // 3: theapp.v1.ListSystemRolesRequest
	(*ListSystemRolesResponse)(nil),           // 4: theapp.v1.ListSystemRolesResponse
	(*ListSystemRolePermissionsRequest)(nil),  // 5: theapp.v1.ListSystemRolePermissionsRequest
	(*ListSystemRolePermissionsResponse)(nil), // 6: theapp.v1.ListSystemRolePermissionsResponse
	...
	(*Role)(nil),          // 9: theapp.v1.Role
	(*emptypb.Empty)(nil), // 10: google.protobuf.Empty
}
var file_system_role_proto_depIdxs = []int32{
	2,  // 0: theapp.v1.ListSystemRolesRequest.filter:type_name -> theapp.v1.SystemRoleFilter
	9,  // 1: theapp.v1.ListSystemRolesResponse.roles:type_name -> theapp.v1.Role
	0,  // 2: theapp.v1.SystemRoleService.AssignSystemRole:input_type -> theapp.v1.AssignSystemRoleRequest
	1,  // 3: theapp.v1.SystemRoleService.UnassignSystemRole:input_type -> theapp.v1.UnassignSystemRoleRequest
	3,  // 4: theapp.v1.SystemRoleService.ListSystemRoles:input_type -> theapp.v1.ListSystemRolesRequest
	5,  // 5: theapp.v1.SystemRoleService.ListSystemRolePermissions:input_type -> theapp.v1.ListSystemRolePermissionsRequest
	7,  // 6: theapp.v1.SystemRoleService.ListSystemRoleAssignments:input_type -> theapp.v1.ListSystemRoleAssignmentsRequest
	10, // 7: theapp.v1.SystemRoleService.AssignSystemRole:output_type -> google.protobuf.Empty
	10, // 8: theapp.v1.SystemRoleService.UnassignSystemRole:output_type -> google.protobuf.Empty
	4,  // 9: theapp.v1.SystemRoleService.ListSystemRoles:output_type -> theapp.v1.ListSystemRolesResponse
	6,  // 10: theapp.v1.SystemRoleService.ListSystemRolePermissions:output_type -> theapp.v1.ListSystemRolePermissionsResponse
	8,  // 11: theapp.v1.SystemRoleService.ListSystemRoleAssignments:output_type -> theapp.v1.ListSystemRoleAssignmentsResponse
