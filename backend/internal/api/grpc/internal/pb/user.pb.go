...
type DeleteUserRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Unique identifier of the active user to delete.
	Id            string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RestoreUserRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Unique identifier of the deleted user to restore.
	Id            string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_user_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tB\v\xe0A\x02\xe2\x8c\xcf\xd7\b\x02\b\x01R\x02id\"0\n" +
	"\x11DeleteUserRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe0A\x02\xe2\x8c\xcf\xd7\b\x02\b\x01R\x02id\"1\n" +
	"\x12RestoreUserRequest\x12\x1b\n" +
	...
	"\x0fnext_page_token\x18\x03 \x01(\tR\rnextPageToken2\xff\x12\n" +
	...
	"\x03500\x122\n" +
	"\x18Unexpected server error.\x12\x16\n" +
	"\x14\x1a\x12.google.rpc.Status\x82\xd3\xe4\x93\x02\x18:\x01*2\x13/v1/users/{user.id}\x12\xfc\x03\n" +
	"\n" +
	"DeleteUser\x12\x1c.theapp.v1.DeleteUserRequest\x1a\x16.google.protobuf.Empty\"\xb7\x03\x92A\x9d\x03J1\n" +
	"\x03400\x12*\n" +
	"\x10Invalid user ID.\x12\x16\n" +
	"\x14\x1a\x12.google.rpc.StatusJ@\n" +
	"\x03401\x129\n" +
	...
	"\x14\x1a\x12.google.rpc.StatusJA\n" +
	"\x03403\x12:\n" +
	" User deletion access is missing.\x12\x16\n" +
	"\x14\x1a\x12.google.rpc.StatusJ7\n" +
	"\x03404\x120\n" +
	"\x16Active user not found.\x12\x16\n" +
	"\x14\x1a\x12.google.rpc.StatusJo\n" +
	"\x03412\x12h\n" +
	"NDeleting the user would remove the last fully privileged system administrator.\x12\x16\n" +
	"\x14\x1a\x12.google.rpc.StatusJ9\n" +
	"\x03500\x122\n" +
	"\x18Unexpected server error.\x12\x16\n" +
	"\x14\x1a\x12.google.rpc.Status\x82\xd3\xe4\x93\x02\x10*\x0e/v1/users/{id}\x12\x92\x03\n" +
	"\vRestoreUser\x12\x1d.theapp.v1.RestoreUserRequest\x1a\x0f.theapp.v1.User\"\xd2\x02\x92A\xb0\x02J1\n" +
	"\x03400\x12*\n" +
	"\x10Invalid user ID.\x12\x16\n" +
	"\x14\x1a\x12.google.rpc.StatusJ@\n" +
	"\x03401\x129\n" +
	...
	"\x03403\x12=\n" +
	"#User restoration access is missing.\x12\x16\n" +
	"\x14\x1a\x12.google.rpc.StatusJ8\n" +
	"\x03404\x121\n" +
	"\x17Deleted user not found.\x12\x16\n" +
	"\x14\x1a\x12.google.rpc.StatusJ9\n" +
	"\x03500\x122\n" +
	"\x18Unexpected server error.\x12\x16\n" +
	"\x14\x1a\x12.google.rpc.Status\x82\xd3\xe4\x93\x02\x18\"\x16/v1/users/{id}:restoreB\xc7\x02\x92A\xa1\x01\x12\x15\n" +
...
var file_user_proto_goTypes = []any{
	...
	(*DeleteUserRequest)(nil),     // 2: theapp.v1.DeleteUserRequest
	(*RestoreUserRequest)(nil),    // 3: theapp.v1.RestoreUserRequest
	(*UpdateUserRequest)(nil),     // 4: theapp.v1.UpdateUserRequest
	(*CreateUserRequest)(nil),     // 5: theapp.v1.CreateUserRequest
	(*UserFilter)(nil),            // 6: theapp.v1.UserFilter
	(*ListUsersRequest)(nil),      // 7: theapp.v1.ListUsersRequest
	(*ListUsersResponse)(nil),     // 8: theapp.v1.ListUsersResponse
	(*timestamppb.Timestamp)(nil), // 9: google.protobuf.Timestamp
	(*fieldmaskpb.FieldMask)(nil), // 10: google.protobuf.FieldMask
	(*emptypb.Empty)(nil),         // 11: google.protobuf.Empty
}
var file_user_proto_depIdxs = []int32{
	9,  // 0: theapp.v1.User.create_time:type_name -> google.protobuf.Timestamp
	9,  // 1: theapp.v1.User.update_time:type_name -> google.protobuf.Timestamp
	9,  // 2: theapp.v1.User.email_verified_time:type_name -> google.protobuf.Timestamp
	0,  // 3: theapp.v1.UpdateUserRequest.user:type_name -> theapp.v1.User
	10, // 4: theapp.v1.UpdateUserRequest.update_mask:type_name -> google.protobuf.FieldMask
	0,  // 5: theapp.v1.CreateUserRequest.user:type_name -> theapp.v1.User
	6,  // 6: theapp.v1.ListUsersRequest.filter:type_name -> theapp.v1.UserFilter
	...
	7,  // 9: theapp.v1.UserService.ListUsers:input_type -> theapp.v1.ListUsersRequest
	5,  // 10: theapp.v1.UserService.CreateUser:input_type -> theapp.v1.CreateUserRequest
	4,  // 11: theapp.v1.UserService.UpdateUser:input_type -> theapp.v1.UpdateUserRequest
	2,  // 12: theapp.v1.UserService.DeleteUser:input_type -> theapp.v1.DeleteUserRequest
	3,  // 13: theapp.v1.UserService.RestoreUser:input_type -> theapp.v1.RestoreUserRequest
	0,  // 14: theapp.v1.UserService.GetUser:output_type -> theapp.v1.User
	8,  // 15: theapp.v1.UserService.ListUsers:output_type -> theapp.v1.ListUsersResponse
	0,  // 16: theapp.v1.UserService.CreateUser:output_type -> theapp.v1.User
	0,  // 17: theapp.v1.UserService.UpdateUser:output_type -> theapp.v1.User
	11, // 18: theapp.v1.UserService.DeleteUser:output_type -> google.protobuf.Empty
	0,  // 19: theapp.v1.UserService.RestoreUser:output_type -> theapp.v1.User
