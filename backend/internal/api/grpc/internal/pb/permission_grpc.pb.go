...
const (
	PermissionService_ListPermissions_FullMethodName = "/theapp.v1.PermissionService/ListPermissions"
)
...
//
// PermissionService exposes permissions available for custom roles.
type PermissionServiceClient interface {
	// Lists permissions that may be granted through a custom role.
...
var PermissionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "theapp.v1.PermissionService",
