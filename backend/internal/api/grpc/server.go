...
var permissionRegistry = map[string][]mdl.Permission{
	...
	"/theapp.v1.RoleService/ListProjectRoleAssignments":      {mdl.PermissionCustomRoleReadProjectAssignments},
	"/theapp.v1.RoleService/ListOrganizationRoleAssignments": {mdl.PermissionCustomRoleReadOrgAssignments},
